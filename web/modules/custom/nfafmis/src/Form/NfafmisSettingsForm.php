...
class NfafmisSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['item-charges'] = [
      ...
      '#description' => $this->t("By clicking the button you can generate annual charges for the years %y1 and %y2.
       <br><strong>Note: Annual charges are meant to be calculated automatically on 1st January of every year. This button can be used to create charges anytime but make sure you understand the consequences. If you are not sure about this don't click on these buttons.</strong>", ['%y1' => $this->last_year, '%y2' => $this->current_year]
      ),
    ];
  ...
  public function calculateAnnualChargesBatch(array &$form, FormStateInterface $form_state) {
    $year = $form_state->getTriggeringElement()['#for_year'];
    if (!$year) {
    ...
    $batch = [
      'operations' => [
        ['Drupal\nfafmis\Form\NfafmisSettingsForm::batchProcess', [$year]],
      ],
   ...
   */
  public static function batchProcess($year, &$context) {
