(function () {
  nfa.map.behaviors.wkt = {
    attach: function (instance) {
      ...
      if (drupalSettings.nfa_map[instance.target].wkt) {
        var wkt = drupalSettings.nfa_map[instance.target].wkt;
        var type = 'vector';
        var opts = {
          title: 'Geometry',
          color: 'orange',
      ...
      if (drupalSettings.nfa_map[instance.target].behaviors.wkt.edit) {
        if (layer !== undefined) {
