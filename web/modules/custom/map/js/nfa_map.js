(function (Drupal) {
  Drupal.behaviors.nfa_map = {
    attach: function (context, settings) {

      // Get the units.
      let units = 'metric';
      if (!!drupalSettings.nfa_map.units) {
        units = drupalSettings.nfa_map.units;
      }
      ...
      context.querySelectorAll('.nfa-map').forEach(function (element) {
        ...
        const mapOptions = { ...defaultOptions, ...drupalSettings.nfa_map[mapId].instance};
